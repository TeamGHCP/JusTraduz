    ...
    <article class="container" style="max-width: 800px; padding: 48px 16px 96px;">
      ...
      <div class="blog-post-content" style="font-size: 16px; line-height: 1.75; color: rgba(0,0,0,0.85); display: grid; gap: 24px;">
        ...
        <p style="margin-top: 32px; border-top: 1px solid rgba(0,0,0,0.08); padding-top: 32px;">
          Se você quer um jeito prático e automatizado para entender seus contratos ou notificações sem complicação, a plataforma <a href="<?= $publicPathPrefix ?>index.php" style="color: var(--primary); font-weight: 600;">JusTraduz</a> oferece uma IA especializada para traduzir o juridiquês das cláusulas de forma segura e rápida.
        </p>
