...
<head>
  ...
  <link rel="stylesheet" href="<?= $assetPrefix ?>assets/css/style.css?v=2026.07.05-blog-polish-1">
...
<body class="blog-post-page terms-page-enhanced">
  ...
  <script src="<?= $assetPrefix ?>assets/js/main.js?v=2026.07.05-blog-polish-1"></script>
