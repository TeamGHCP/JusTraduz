    ...
    <main class="app-main">
      ...
      <section class="profile-layout">
        ...
        <form class="card auth-form" action="../backend/public/index.php?rota=/profile/update" method="post">
          ...
          <?php endif; ?>
          <div class="dash-section-title mt-24"><h2>Alterar senha</h2></div>
          <div class="form-grid">
            <div class="field"><label for="senha_atual">Senha atual</label><input class="input" id="senha_atual" name="senha_atual" type="password"></div>
            <div class="field"><label for="nova_senha">Nova senha</label><input class="input" id="nova_senha" name="nova_senha" type="password" minlength="6"></div>
            <div class="field"><label for="nova_senha2">Confirmar nova senha</label><input class="input" id="nova_senha2" name="nova_senha2" type="password" minlength="6"></div>
          </div>
