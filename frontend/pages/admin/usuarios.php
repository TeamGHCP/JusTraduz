      ...
      <section class="dash-section">
        ...
        <?php else: ?>
          <div class="table-wrap">
            <table class="table">
              <thead><tr><th>Usuário</th><th>Contato</th><th>Perfil</th><th>OAB</th><th>Status</th><th>Criado em</th><th>Ação</th></tr></thead>
              <tbody>
                <?php foreach ($users as $user): ?>
                  <tr>
                    ...
                    <td>
                      <form class="inline-form action-form" action="<?= e(app_url('/backend/public/index.php?rota=/admin/users/status')) ?>" method="post">
                        <?= csrf_input() ?>
