...
{
    return match ($type ?? current_user_type()) {
        'advogado' => '/justraduz/frontend/dashboard-advogado.php',
        'estagiario' => '/justraduz/frontend/dashboard-estagiario.php',
        'admin' => '/justraduz/frontend/admin/dashboard-admin.php',
        default => '/justraduz/frontend/dashboard-cliente.php',
    };
}
...
function dashboard_nav_items(string $type, bool $isAdminPath = false): array
{
    return match ($type) {
        ...
        'admin' => $isAdminPath ? [
            ['href' => 'dashboard-admin.php', 'label' => 'Métricas', 'icon' => 'chart'],
            ['href' => '../perfil.php', 'label' => 'Perfil', 'icon' => 'user'],
            ['href' => '../acompanhar-solicitacoes.php', 'label' => 'Solicitações', 'icon' => 'case'],
            ['href' => '../chat.php', 'label' => 'Chat', 'icon' => 'chat'],
        ] : [
            ['href' => 'admin/dashboard-admin.php', 'label' => 'Métricas', 'icon' => 'chart'],
            ['href' => 'perfil.php', 'label' => 'Perfil', 'icon' => 'user'],
            ['href' => 'acompanhar-solicitacoes.php', 'label' => 'Solicitações', 'icon' => 'case'],
            ['href' => 'chat.php', 'label' => 'Chat', 'icon' => 'chat'],
        ],
...
function render_sidebar(string $type, string $active, bool $isAdminPath = false): void
{
    ...
    $brandHref = $isAdminPath ? 'dashboard-admin.php' : match ($type) {
...
function stat_card(string $label, int|string $value, string $icon): string
{
