...
function icon_svg(string $name): string
{
    $icons = [
        ...
        'help-bubble' => '<path d="M12 3.25a8.75 8.75 0 0 0-7.62 13.05l-1.13 4.45 4.45-1.13A8.75 8.75 0 1 0 12 3.25Z"/><path d="M9.35 9.45a2.75 2.75 0 1 1 4.85 1.78c-.95.82-1.7 1.3-1.7 2.77"/><path d="M12.5 17.15h.01"/>',
