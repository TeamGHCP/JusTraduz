...
function seed_test_data(PDO $pdo): void
{
    ...
    $pdo->exec("INSERT INTO plans (id, slug, name, description, monthly_price_cents, yearly_price_cents, limits_json, features_json, active, sort_order) VALUES
        ...
        (4, 'gratuito', 'Gratuito', 'Plano inicial liberado automaticamente apos o onboarding.', 0, 0, '{\"document_upload\":5,\"document_ai\":5,\"ai_chat\":50,\"datajud_cnj\":1,\"ocr\":5}', '[\"5 documentos por mes\",\"5 analises com IA\",\"50 mensagens com IA Juridica\",\"1 consulta CNJ por mes\"]', 1, 1)");
